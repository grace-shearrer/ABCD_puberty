...
```{r}
aseg<-read.table("~/Google Drive/ABCD/ABCD_puberty/_data/TOS2020/midaparc01.txt", header=T, sep="\t")
QC<-read.table("~/Google Drive/ABCD/ABCD_puberty/_data/TOS2020/abcd_mrirstv01.txt", header=T, sep="\t")
```
