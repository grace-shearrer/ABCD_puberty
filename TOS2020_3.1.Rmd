...
subcort<-df_subcort %>%
  select(subjectkey, contains("caudate"),contains("putamen"),contains("pallidum"), contains("thlpp"),contains("amygdala"), contains("accarea"), contains("ventraldc"), contains("hthp"))
# head(subcort)
