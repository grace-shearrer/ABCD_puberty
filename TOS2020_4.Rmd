...
```{r}
ggplot(data, aes(x=PCSum*BMIsds*WCsds, y=change_putamen_L, color = gender)) +
    geom_point(shape=1) +    # Use hollow circles
    geom_smooth(method=lm) + theme_classic()    # Don't add shaded confidence region


ggplot(data, aes(x=PCScore, y=change_putamen_R, color = central_ob)) + geom_violin() + theme_bw()
ggplot(data, aes(x=PCScore, y=change_putamen_L, color = central_ob)) + geom_violin() + theme_bw()
